...
%if 0%{?rhel} >= 7 || 0%{?fedora} || (0%{?amzn1} && %{with X11})
%global gnome_keyring 1
%else
%global gnome_keyring 0
%endif

%if (0%{?fedora} && 0%{?fedora} < 19) || (0%{?rhel} && 0%{?rhel} < 7) || 0%{?amzn}
...
# tell xslt to not download stuff off the 'net when building docs
sed -i -r -e "s/^XSLTOPTS =/XSLTOPTS = --nonet/" Documentation/Makefile
...
- import source package F19/git-1.8.3.1-1.fc19
...
* Thu Mar 14 2013 Lee Trager <ltrager@amazon.com>
- import source package F18/git-1.8.1.4-1.fc18
...
* Wed Jan 30 2013 Lee Trager <ltrager@amazon.com>
- import source package F18/git-1.8.1.2-1.fc18

* Wed Jan 30 2013 Adam Tkac <atkac redhat com> - 1.8.1.2-1
- update to 1.8.1.2
- own directories which should be owned (#902517)

* Thu Jan 3 2013 Lee Trager <ltrager@amazon.com>
- import source package F18/git-1.8.1-1.fc18
...
* Mon Dec 3 2012 Lee Trager <ltrager@amazon.com>
- import source package F18/git-1.8.0.1-1.fc18

* Thu Nov 29 2012 Adam Tkac <atkac redhat com> - 1.8.0.1-1
- update to 1.8.0.1
- include git-subtree in git rpm (#864651)

* Tue Nov 27 2012 Lee Trager <ltrager@amazon.com>
- import source package F18/git-1.8.0-1.fc18
...
* Wed Jun 22 2011 Cristian Gafton <gafton@amazon.com>
- typo fix for macro defines
- updated to 1.7.4.5
- git amzn macro usage in spec file build
...
* Thu Mar 24 2011 Cristian Gafton <gafton@amazon.com>
...
* Fri Aug 20 2010 Cristian Gafton <gafton@amazon.com>
- fix gitweb generation
- update to 1.7.2.2
...
- do not download stuff off the net whrn building docs
- undo make -s builds
...
- remove BuildArch: noarch lines - they are not supported by our current rpm

* Sat Jul 10 2010 Cristian Gafton <gafton@amazon.com>
- wip: update/simpplyfy spec file
- upgrade to version 1.7.1.1
- import source package GOBI/git-1.7.1.1-1
